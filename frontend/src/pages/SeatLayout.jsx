...
const SeatLayout = () => {
	...
	useEffect(() => {
		getShow();
		console.log("🚀 ~ SeatLayout ~ show:", show);
	}, [id]);
	...
	return show ? (
		<div className="flex flex-col md:flex-row px-6 md:px-16 lg:px-40 py-30 md:pt-50">
			...
			<div className="relative flex flex-col flex-1 items-center max-md:mt-16">
				...
				<div className="flex flex-col items-baseline mt-10 text-xs text-gray-300">
			...
			transition rounded-full font-medium cursor-pointer hover:scale-95"
				>
					Proceed to Checkout
